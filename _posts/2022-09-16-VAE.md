...
때문에, 일단 논문을 이해하는데 필수적인 통계지식 세 가지만 짚고 넘어가겠습니다.
<br>
<br>
### ML(Maximum Likelihood)
ML은 파라미터를 찾는 method로, 가장 높은 가능도를 갖게 해주는 파라미터를 찾는 방법입니다. 즉, 현재 우리가 갖고 있는 데이터가 발생할 확률을 가장 높여주는 파라미터를 찾는 method입니다.
<br>
